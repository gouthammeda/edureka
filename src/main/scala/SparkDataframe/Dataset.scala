...
object Dataset {
  def main(args: Array[String]) {
    ...
    //Dataset
    //val employeeDS = spark.read.json("/user/gowthambha87edu/sparkDF/people.json").as[employee]
    //Dataframe
    val employeeDF = spark.read.json("/user/gowthambha87edu/sparkDF/people.json")
